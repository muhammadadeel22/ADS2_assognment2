...
d4_group.plot(x="Year", y=["Value"], kind="bar", figsize=(9, 8))
d5_group.plot(x="Year", y=["Value"], kind="bar", figsize=(9, 8))
d4_group.plot(x="Year", y=["Value"], kind="line", figsize=(9, 8))
d5_group.plot(x="Year", y=["Value"], kind="line", figsize=(9, 8))